...
class ShippingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['shipping_fullname', 'shipping_email', 'shipping_email', 'shipping_address1', 'shipping_address2', 'shipping_city', 'shipping_state', 'shipping_zipcode', 'shipping_country']
...
class PaymentForm(forms.Form):
    ...
    card_address2 = forms.CharField(label='', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Card Address1'}), required=False)
